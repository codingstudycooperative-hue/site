              ...
              <div className="bg-white border border-slate-100 shadow-xl shadow-slate-200/20 rounded-3xl p-10 relative overflow-hidden">
                ...
                <div className="space-y-6 relative z-10">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="pt-1.5 font-semibold text-slate-700">
                      협동조합 설립
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
            ...
            <div className="space-y-10">
              <div>
                ...
                <p className="text-base text-slate-600 leading-relaxed">
                  코딩스터디 협동조합은 SW·AI 교육을 통해 지역 사회의 디지털
                  역량을 높이고,{" "}
                  <span className="font-bold text-primary-600">
                    누구나 배움의 기회를 누릴 수 있는 교육 환경
                  </span>
                  을 만들기 위해 설립되었습니다. 지역의 학생과 시민들에게
                  소프트웨어 교육 기회를 제공하고 취약계층에게 일자리와
                  사회서비스를 지원함으로써 사회적 가치를 실현하고 지역 사회에
                  기여하고자 합니다.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-base text-slate-600 leading-relaxed">
                  조합원들은 SW·AI 교육 경험을 갖춘 교육 전문가들로 구성되어
                  있으며, 지역 교육 네트워크를 바탕으로{" "}
                  <span className="font-bold text-primary-600">
                    협력과 나눔의 가치
                  </span>
                  를 실천하고 있습니다.
      ...
      <section className="py-24 px-6 bg-slate-50 border-t border-slate-100">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-primary-600 font-bold tracking-widest text-sm uppercase mb-2 block">
              Vision
            </span>
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-10">
            {/* 배움 */}
            <div className="bg-white rounded-3xl p-8 lg:p-10 border border-slate-100 hover:shadow-lg hover:border-primary-200 transition-all flex flex-col group">
              <div className="w-20 h-20 bg-blue-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary-600 transition-colors">
                <span className="text-2xl font-black text-primary-600 group-hover:text-white transition-colors">
                  배움
                </span>
              </div>
              <p className="text-slate-600 leading-relaxed text-left">
                변화하는 SW·AI 기술과 교육 방법을 지속적으로 배우고 연구하며, 더
                나은 교육을 제공하기 위해 교육 역량을 꾸준히 발전시켜 나갑니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 border border-slate-100 hover:shadow-lg hover:border-primary-200 transition-all flex flex-col group">
              <div className="w-20 h-20 bg-emerald-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-emerald-500 transition-colors">
                <span className="text-2xl font-black text-emerald-600 group-hover:text-white transition-colors">
                  나눔
                </span>
              </div>
              <p className="text-slate-600 leading-relaxed text-left">
                배움을 통해 얻은 지식과 경험을 지역 사회와 나누며, 더 많은
                사람들이 SW·AI 교육의 기회를 접할 수 있도록 교육 활동을
                확산합니다.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-10 border border-slate-100 hover:shadow-lg hover:border-primary-200 transition-all flex flex-col group">
              <div className="w-20 h-20 bg-indigo-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-indigo-600 transition-colors">
                <span className="text-2xl font-black text-indigo-600 group-hover:text-white transition-colors">
                  이룸
                </span>
              </div>
              <p className="text-slate-600 leading-relaxed text-left">
                교육을 통해 개인의 성장과 지역 사회의 발전이 함께 이루어질 수
                있도록 사회적 가치를 담은 지속 가능한 교육 가치와 성과를 만들어
                갑니다.
              </p>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="flex gap-6 p-8 rounded-3xl bg-white border hover:border-primary-200 border-slate-100 transition-all hover:shadow-md group">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  학생 및 일반인을 대상으로 실습 중심의 다양한 SW·AI 교육을
                  운영하여 디지털 역량을 기를 수 있도록 적극 지원합니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-6 p-8 rounded-3xl bg-white border hover:border-primary-200 border-slate-100 transition-all hover:shadow-md group">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  교육 현장에서 즉시 활용할 수 있는 양질의 SW·AI 교육 커리큘럼과
                  맞춤형 콘텐츠를 연구 개발하여 학교와 기관에 보급합니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-6 p-8 rounded-3xl bg-white border hover:border-primary-200 border-slate-100 transition-all hover:shadow-md group">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  교육 인력을 대상으로 체계적인 강사 양성 프로그램을 운영하여,
                  지역 교육 현장에 투입될 수 있는 활동 전문 인력을 확대합니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-6 p-8 rounded-3xl bg-white border hover:border-primary-200 border-slate-100 transition-all hover:shadow-md group">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">
                  다양한 종류의 최신 디지털 교육 교구를 저렴하게 대여하여
                  교육기관과 강사가 인프라 부담 없이 쉽게 교육을 진행하도록
                  돕습니다.
                </p>
              </div>
            </div>
